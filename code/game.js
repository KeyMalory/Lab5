function Level(plan) {
/*lotta comments, part matters is up top-ish?

if elseif
taking the character in the file and mapping it, x to wall, ! to lava.
fieldtype refers to a CSS class, classes have "." in front of them.
.wall draws bg w white.
.lava makes red shit.


keyboard shortcut, gotta run it from index.html or it wont work
*/
